...
**R16 StemTool** is a lightweight desktop application designed to streamline the workflow of music producers. It automatically analyzes your exported audio stems, detects their **Key** and **BPM**, and renames them by baking the metadata directly into the filename — using any naming format you choose.
...
R16 StemTool ships with platform-specific presets. Click **▶ Naming Pattern** to expand the bar, then switch presets or build your own by clicking token chips:
...
### Windows
```bash
git clone https://github.com/edisonALP/R16_StemTool.git
cd R16_StemTool
...
2. **Import:** Drag & drop your stem folder into R16 StemTool
